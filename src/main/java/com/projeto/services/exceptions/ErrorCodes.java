...
public final class ErrorCodes {
    ...
    public static final String CARTEIRA_POSSUI_SNAPSHOTS = "CARTEIRA_POSSUI_SNAPSHOTS";
    public static final String SNAPSHOT_CARTEIRA_DUPLICADO = "SNAPSHOT_CARTEIRA_DUPLICADO";
