...
@Component({
  ...
  styles: [`:host{width:1.25rem;height:1.25rem;display:inline-grid;place-items:center;flex:0 0 auto;color:inherit;vertical-align:middle;line-height:1}:host svg{width:100%;height:100%;display:block;fill:currentColor}`],
